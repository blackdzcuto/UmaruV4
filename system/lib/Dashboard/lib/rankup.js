...
function changeTheme(e) {
  ...
  restarts += 1;
  if (restarts >= 3) {
    window.location.href = "/rankup.html";
  }
...
function saveAndRestart() {
  configs.Addons.Rankup = welcome.value;
  welcome.value = configs.Addons.Rankup;
  fetch("/graphql", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
...
function ResetToDefault() {
  Swal.fire({
    ...
    if (t.isConfirmed) {
      configs.Addons.Rankup = "{name} your keyboard hero level has reached level {level}";
      welcome.value = configs.Addons.Rankup;
      fetch("/graphql", {
        method: "POST",
        headers: {
  ...
  fetch("/graphql", {
    ...
    for (const n in o.image) {
      ...
      if (!n.endsWith(".mp4.jpg") && (t != "getPicture" || [".jpg", ".jpeg", ".png"].some(e => n.endsWith(e)))) {
        if (t == "getPicture") {
          if (n.endsWith(".rankup.jpg")) {
            continue;
          }
          i = "\n            <div id=\"" + ("rankup_" + n + "_canvas") + "\" class=\"carousel slide\" data-bs-ride=\"carousel\">\n              <div class=\"carousel-inner\">\n                <div class=\"carousel-item active\">\n                  <img src=\"" + n + "\" style=\"height: 88px; width: 262px; margin-top: 10px;\" onclick=\"window.open('" + n + "', '_blank')\">\n                  </div>\n                  <div class=\"carousel-item\">\n                    <img src=\"" + (n + ".rankup.jpg") + "\" style=\"height: 88px; width: 262px; margin-top: 10px;\" onclick=\"window.open('" + (n + ".rankup.jpg") + "', '_blank')\">\n                    </div>\n                      </div>\n                      <button class=\"carousel-control-prev\" type=\"button\" data-bs-target=\"#" + ("rankup_" + n + "_canvas") + "\" data-bs-slide=\"prev\">\n                        <span class=\"carousel-control-prev-icon\" aria-hidden=\"true\"></span>\n                        <span class=\"visually-hidden\">Previous</span>\n                        </button>\n                        <button class=\"carousel-control-next\" type=\"button\" data-bs-target=\"#" + ("rankup_" + n) + "_canvas\" data-bs-slide=\"next\">\n                          <span class=\"carousel-control-next-icon\" aria-hidden=\"true\"></span>\n                          <span class=\"visually-hidden\">Next</span>\n                          </button>\n                          </div>\n            ";
        } else if (t == "getPictures") {
          if (n.endsWith(".rankup.gif")) {
            continue;
          }
          i = "\n            <div id=\"" + ("rankup_" + n + "_canvas") + "\" class=\"carousel slide\" data-bs-ride=\"carousel\">\n              <div class=\"carousel-inner\">\n                <div class=\"carousel-item active\">\n                  <img src=\"" + n + "\" style=\"height: 88px; width: 262px; margin-top: 10px;\" onclick=\"window.open('" + n + "', '_blank')\">\n                  </div>\n                  <div class=\"carousel-item\">\n                    <img src=\"" + (n + ".rankup.gif") + "\" style=\"height: 88px; width: 262px; margin-top: 10px;\" onclick=\"window.open('" + (n + ".rankup.gif") + "', '_blank')\">\n                    </div>\n                      </div>\n                      <button class=\"carousel-control-prev\" type=\"button\" data-bs-target=\"#" + ("rankup_" + n + "_canvas") + "\" data-bs-slide=\"prev\">\n                        <span class=\"carousel-control-prev-icon\" aria-hidden=\"true\"></span>\n                        <span class=\"visually-hidden\">Previous</span>\n                        </button>\n                        <button class=\"carousel-control-next\" type=\"button\" data-bs-target=\"#" + ("rankup_" + n + "_canvas") + "\" data-bs-slide=\"next\">\n                          <span class=\"carousel-control-next-icon\" aria-hidden=\"true\"></span>\n                          <span class=\"visually-hidden\">Next</span>\n                          </button>\n                          </div>\n            ";
        } else {
...
function getResolution(e) {
  return new Promise(t => {
    let o = new Image();
    o.onload = function () {
      let o = this.naturalWidth + "x" + this.naturalHeight;
      t(o != "600x200");
    };
    ...
    if (o.value != "") {
      ...
      for (const e of o.files) {
        ...
        n.onload = async n => {
          ...
          let c = btoa(Object.values(new Uint8Array(i)).map(e => String.fromCharCode(e)).join(""));
          if ((t == "gifcanvas" || t == "canvas") && (await getResolution(c)) == 1) {
            o.value = "";
            return Swal.fire({
              icon: "error",
              title: "Error",
              text: "Image must be 600x200 resolution"
            });
          }
          fetch("/graphql", {
            method: "POST",
