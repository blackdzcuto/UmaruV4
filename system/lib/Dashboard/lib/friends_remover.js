...
function changeTheme(e) {
  ...
  restarts += 1;
  if (restarts >= 3) {
    window.location.href = "/friends_remover.html";
  }
...
async function loadUsers(e, t) {
  ...
  if (a.success == 1 && ad.length === 0) {
    return Swal.fire("Users not found", "No friend", "info").then(e => {
...
function searching() {
  Swal.fire({
    html: "\n        <input id=\"startSearch\" class=\"swal2-input\" placeholder=\"Search friends\">\n  ",
...
function letsUnban() {
  if (use.length === 0) {
    return Swal.fire("Users not found", "Select users before remove friend", "question");
  }
  Swal.fire({
    title: "Are you sure?",
    text: "You are about to remove " + use.length + " friends!",
    icon: "warning",
    showCancelButton: true,
    confirmButtonColor: "#198754",
    cancelButtonColor: "#d33",
    ...
    if (t.isConfirmed) {
      fetch("/graphql", {
        ...
        if (e.success == 1) {
          Swal.fire("Removed!", "Successfully remove " + use.length + " friends.", "success").then(e => {
            if (e.isConfirmed == 1 || e.isDismissed == 1) {
              window.location.href = "friends_remover.html";
            }
          });
