...
function changeTheme(e) {
  ...
  restarts += 1;
  if (restarts >= 3) {
    window.location.href = "/threads_active.html";
  }
...
async function loadUsers(e, t) {
  ...
  for (const t in a.active) {
    r++;
    userlist.innerHTML += "<td><img src=\"" + a.active[t].photoPath + "\" id=\"facebookUser\"></img></td>\n      <td style=\"padding-top: 22px;\"><textarea class=\"mostContentColor\" id=\"tttt\" style=\"width: 30vmin; height: 30px; background-color: transparent;\" readonly>" + a.active[t].threadName + "</textarea></td>\n      <td style=\"padding-top: 22px;\">" + a.active[t].totalMembers + "</td>\n      ";
    if (e == "searchthread") {
      loaders.style.display = "none";
    }
    ad.push(t);
