...
function _0x3b0b3d(e) {
  ...
  function changeTheme(e) {
    ...
    restarts += 1;
    if (restarts >= 3) {
      window.location.href = "/threads_inactive.html";
    }
    document.getElementById("UmaruTheme").href = e == "light" ? "lib/light.css" : "lib/dark.css";
    if (n == "light") {
      document.getElementById("DarkAndLight").setAttribute("class", "fa-solid fa-sun");
  ...
  async function loadUsers(e, t) {
    ...
    for (const t in a.inactive) {
      r++;
      userlist.innerHTML += "<td><img src=\"" + a.inactive[t].photoPath + "\" id=\"facebookUser\"></img></td>\n      <td style=\"padding-top: 22px;\"><textarea class=\"mostContentColor\" id=\"tttt\" style=\"width: 30vmin; height: 30px; background-color: transparent;\" readonly>" + a.inactive[t].threadName + "</textarea></td>\n      <td style=\"padding-top: 22px;\">" + a.inactive[t].totalMembers + "</td>\n      ";
      if (e == "searchthread") {
        loaders.style.display = "none";
      }
      ad.push(t);
