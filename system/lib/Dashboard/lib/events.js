...
function switchData(t) {
  if (document.getElementById(t).checked == 1) {
    let n = DisableEvents.filter(e => e !== t);
    DisableEvents = n;
  } else {
    DisableEvents.push(t);
  }
  fetch("/graphql", {
    method: "POST",
    headers: {
